...
# Protected inference, market intelligence, and feedback endpoints (require internal pre-shared key)
...
api_v1_router.include_router(market_router, dependencies=[Depends(verify_internal_api_key)])
